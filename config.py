...
class Config(object):
    ...
    def __init__(self):
        ...
        self.dataset_name = "vhe" # extracts dataset info from dataset.py
        self.log_dir = "prelim_vhe_checkpoints" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
        "/home/remedilw/code/hover_net/dataset/prelim_vhe/vhe/vhe/train/540x540_164x164/"
        ]
        self.valid_dir_list = [
        "/home/remedilw/code/hover_net/dataset/prelim_vhe/vhe/vhe/train/540x540_164x164/"
        ]
